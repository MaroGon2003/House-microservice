...
public class PaginationValidator {
    ...
    public static void validatePaginationParameters(int page, int size, String sortBy, String sortDirection) {
        if (page < 0) {
        ...
        if (sortBy == null || sortBy.isEmpty()) {
            throw new IllegalArgumentException(ErrorMessages.SORT_BY_NULL_OR_EMPTY_ERROR);
        }

...
public class RealEstateValidationUtil {
    ...
    public static void validateDescription(String description) {
        ...
        if (description.length() < DomainConstants.DESCRIPTION_MIN_LENGTH || description.length() > DomainConstants.DESCRIPTION_MAX_LENGTH) {
            throw new IllegalArgumentException(DomainConstants.DESCRIPTION_LENGTH_ERROR);
        }
    }
